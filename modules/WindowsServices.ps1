...
$ServicesInfo = $ServicesInfo -replace '<table>','<div class="container"><input type="text" id="serviceInput" onkeyup="myServicesFunction()" placeholder="Search for Services Names.." title="Type in some text"></input><table id="servicesTable" class="table table-dark table-hover table-striped table-bordered">'
